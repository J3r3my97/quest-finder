...
const mockContracts: Record<string, ContractLead & { fullDescription: string; contactInfo: { name: string; email: string; phone: string } }> = {
  "1": {
    id: "1",
...
function getSetAsideLabel(type: SetAsideType | null): string {
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-2xl font-bold">{formatDate(contract.deadline)}</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
